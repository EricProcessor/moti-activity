	...
	<view class="panel-body">
		...
		<view class="brother" >
			...
			<view class="attrs-wrapper">
				...
				<view class="attrs-group">
					<view :key="index" class="item-color" :class="{active: index === currentBrotherIndex,m4: (index%4 == 3 )}" @touchend="chooseBrother"
					 :data-index="index" v-for="(item,index) in brother.spec">
						{{item.text}}
					</view>
			...
			<view class="purchase-wrapper">
				...
				<view class="number-handle">
					<view class="del" @click="numsDownBrother">
						-
					</view>
					<view class="number">
						{{buyNumbersBrother}}
					</view>
					<view class="add" @click="numsUpBrother">
						+
					</view>
				</view>
			</view>
